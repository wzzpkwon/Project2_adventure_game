...
# function to validate input and to repeat input messages until valid input is entered.
...
# function to print introductions that sets the tone in the beginning of a game.
def intro():
...
# function to work on computer to hack the computer and to download security code.
